# Scenario 06 — App can't reach Aurora writer
...
| t (min) | Layer | Event |
|---|---|---|
| 0 | Test driver | Inject the scenario condition (see `tests/chaos/test_scenario_06_app_cant_reach_aurora.py`). |
...
> **No automatic failover. Tier 1 stays green. SNS HIGH alert from a Tier 2 derived signal. Operator decides.**
...
Tier 2 issues require operator judgment; Tier 1 is the only trigger surface.
