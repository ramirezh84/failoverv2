# Scenario 02 — ALB unhealthy only
...
| t (min) | Layer | Event |
|---|---|---|
| 0 | Test driver | Inject the scenario condition (see `tests/chaos/test_scenario_02_alb_unhealthy_only.py`). |
...
> **GREEN/WATCHING; Tier 3 alb_unhealthy red; Tier 1 quorum=0.**
...
Tier 3 sustained over the dwell window does not trigger.
