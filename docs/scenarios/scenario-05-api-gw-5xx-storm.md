# Scenario 05 — API Gateway 5xx storm
...
| t (min) | Layer | Event |
|---|---|---|
| 0 | Test driver | Inject the scenario condition (see `tests/chaos/test_scenario_05_api_gw_5xx_storm.py`). |
...
> **GREEN; Tier 3 api_gw_5xx red; Tier 1 quorum=0.**
...
Tier 3 noise does not authorize even at 100% rate.
