"""Scenario 05: API Gateway 5xx rate spikes to 100% in primary. NO failover (Tier 3 only).

See ``docs/scenarios/scenario-05-api-gw-5xx-storm.md`` for the full minute-by-minute
