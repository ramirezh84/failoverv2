"""Scenario 02: non-mutating signal injection — verify no failover was triggered.

See ``docs/scenarios/scenario-02-alb-unhealthy-only.md`` for the walkthrough.
...
def test_scenario_02() -> None:
    def setup() -> None:
        ...
        fw.force_signal_red("alb_unhealthy", 1.0)
