"""Scenario 06: non-mutating signal injection — verify no failover was triggered.

See ``docs/scenarios/scenario-06-app-cant-reach-aurora.md`` for the walkthrough.
...
def test_scenario_06() -> None:
    def setup() -> None:
        ...
        fw.force_signal_red("aurora_connectivity", 1.0)
    ...
    result = fw.run_scenario(
        name="scenario-06-app-cant-reach-aurora",
        setup=setup,
        wait_seconds=90,
