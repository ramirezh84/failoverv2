"""Scenario 06: Primary cannot reach Aurora writer; routable endpoint + canary green. NO automatic failover.

See ``docs/scenarios/scenario-06-app-cant-reach-aurora.md`` for the full minute-by-minute
