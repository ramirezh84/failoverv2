"""Scenario 11: Mid-failover Lambda crash. State machine resumes from last successful state; idempotency holds.

See ``docs/scenarios/scenario-11-mid-failover-lambda-crash.md`` for the full minute-by-minute
